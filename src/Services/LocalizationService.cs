...
public class LocalizationService
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ["zh"] = new Dictionary<string, string>
        {
            ...
            ["Theme"] = "主题",
            ["ThemeTip"] = "界面外观颜色模式（需重启生效）",
            ["ThemeSystem"] = "跟随系统",
            ["ThemeLight"] = "浅色",
            ["ThemeDark"] = "深色",
            ["ThemeChangedTip"] = "主题已变更，重启后生效",
            ["Language"] = "语言",
            ["LanguageTip"] = "界面显示语言",
            ["LangSystem"] = "跟随系统",
            ["LangZh"] = "中文",
            ...
            ["ColumnType"] = "类型",
            ["ColumnFileType"] = "文件类型",
            ["FileType_ParentDir"] = "上级目录",            ["FileType_Folder"] = "文件夹",            ["FileType_Code"] = "代码",            ["FileType_Excel"] = "Excel表格",            ["FileType_Word"] = "Word文档",            ["FileType_PPT"] = "PPT幻灯片",            ["FileType_PDF"] = "PDF文档",            ["FileType_Image"] = "图片",            ["FileType_Video"] = "视频",            ["FileType_Audio"] = "音频",            ["FileType_Archive"] = "压缩包",            ["FileType_Text"] = "文本文件",            ["FileType_Config"] = "配置文件",            ["FileType_Web"] = "网页",            ["FileType_Executable"] = "可执行文件",            ["FileType_Document"] = "文档",            ["FileType_Code"] = "代码",
            ["ColumnName"] = "名称",
            ["ColumnStatus"] = "状态",
            ["ColumnSize"] = "大小",
            ["ColumnModified"] = "修改时间",
            ...
            ["TreeConflictKeepLocalOnly"] = "树冲突：仅支持保留本地",
            ["KeepAllLocal"] = "全选保留本地",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["Theme"] = "Theme",
            ["ThemeTip"] = "Application color mode (restart required)",
            ["ThemeSystem"] = "Follow System",
            ["ThemeLight"] = "Light",
            ["ThemeDark"] = "Dark",
            ["ThemeChangedTip"] = "Theme changed, takes effect after restart",
            ["Language"] = "Language",
            ...
            ["FileType_ParentDir"] = "Parent Directory",            ["FileType_Folder"] = "Folder",            ["FileType_Code"] = "Code",            ["FileType_Excel"] = "Excel",            ["FileType_Word"] = "Word Document",            ["FileType_PPT"] = "PPT Presentation",            ["FileType_PDF"] = "PDF Document",            ["FileType_Image"] = "Image",            ["FileType_Video"] = "Video",            ["FileType_Audio"] = "Audio",            ["FileType_Archive"] = "Archive",            ["FileType_Text"] = "Text File",            ["FileType_Config"] = "Config File",            ["FileType_Web"] = "Web",            ["FileType_Executable"] = "Executable",            ["FileType_Document"] = "Document",            ["FileType_Code"] = "Code",
            ["ColumnName"] = "Name",
            ["ColumnStatus"] = "Status",
            ["ColumnSize"] = "Size",
            ...
            ["ManualSyncInProgress"] = "Syncing now...",
            ...
            ["TreeConflictKeepLocalOnly"] = "Tree conflict: Keep Local only",
